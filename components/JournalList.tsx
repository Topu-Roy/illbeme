...
export function JournalList() {
  ...
  const createEntry = api.journal.createJournals.useMutation();
  const deleteEntry = api.journal.deleteJournals.useMutation();
  const updateEntry = api.journal.updateJournals.useMutation();
