          ...
          {!burned ? (
            ...
            >
              <Textarea
                ...
                className="min-h-50 resize-none border-orange-100 text-base focus-visible:ring-orange-500 dark:border-orange-900/50"
                disabled={isBurning}
              />
              {isBurning && (
            ...
            <div className="animate-in zoom-in flex min-h-50 flex-col items-center justify-center gap-4 text-center duration-700">
